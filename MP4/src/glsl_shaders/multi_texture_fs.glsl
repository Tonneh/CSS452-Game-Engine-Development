...
uniform float rBlendWeight;
uniform float rBlendWeight2;
...
void main(void)  {
    ...
    (vTexCoord2.t <= 1.0)
        ...
        if (c2.a > 0.9) {
            // Blending function ...
            vec3 blendColor = ((1.0 - rBlendWeight) * vec3(c2));
            r = r * rBlendWeight + blendColor;
            a = length(blendColor) + ((1.0 - rBlendWeight) * a);
        }
    }
    ...
    (vTexCoord3.t <= 1.0)
        ...
        if (c3.a > 0.9) {
            // Blending function ...
            vec3 blendColor = ((1.0 - rBlendWeight2) * vec3(c3));
            r = r * rBlendWeight2 + blendColor;
            a = length(blendColor) + ((1.0 - rBlendWeight2) * a);
        }
    }
