...
class MyGame {
    ...
    drawHexagonRow() {
        engine.drawHexagon(black, [col1, row3], scale1);
        engine.drawHexagon(lightRed, [col2, row3], scale2);
        engine.drawHexagon(orange, [col3, row3], scale3);
        engine.drawHexagon(pink, [col4, row3], scale4);
        engine.drawHexagon(skyBlue, [col5, row3], scale5);
    }
