...
class GrayLevel extends engine.Scene {
    ...
    init() {
        ...
        if (!Storage.hasSmallCamera()) {
            ...
            this.smallCamera.setBackgroundColor([0.678, 0.847, 0.902, 1]);
    ...
    update() {
        ...
        // Move small camera pixel positions
        this.moveSmallCameraPixelPosition();

        // zoom in and out main camera
        this.zoomMainCamera();

        // move the WC of main camera
        this.moveMainCameraWC();

        // rotate the redRectangle
        this.rotateRectangle();

        // rotate the whiteRectangle
